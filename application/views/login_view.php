...
@media only screen and (max-width: 600px) {
    .navbar-inverse {
        /* Atur tampilan navigasi sesuai kebutuhan di perangkat seluler */
        background-color: #555; /* Misalnya, mengubah warna latar belakang */
    }

    .navbar-color {
        /* Sesuaikan warna teks sesuai kebutuhan di perangkat seluler */
        color: #fff;
    }
}
...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/siper.jpeg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: yellow;">Sistem <br/><b>Perpustakaan</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: yellow;"> Designer &copy; Sistem Perpustakaan - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
