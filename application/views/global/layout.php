...
<body>
    ...
    <nav class="teal darken-2">
      <div class="container">
        ...
        <div class="nav-wrapper">
          <a href="<?php echo base_url(); ?>Buku" class="brand-logo"><img
              src="<?php echo base_url(); ?>assets2/img/nuha.png" width="45px" alt=""></a>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img z-depth-5" width="200px" src="<?php echo base_url(); ?>assets2/img/nuha.png"
            alt="" srcset="">
        </div>
        <h3 class="header center white-text text-lighten-2 z-depth-5">PERPUSTAKAAN SMK NURUL HAYYAH</h3>


      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/Buku.jpg" alt="Unsplashed background img 1">
    </div>
  </div>
  <!-- Slider end -->
  ...
  <footer class="teal darken-2">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          Designer &copy; : <a href="" target="_blank">2024 SMK NUHA Brebes</a>
        </div>
