					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="orange" id="id-company-text">SMK NUHA BREBES</h4>
							</div>
												...
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														...
														$username_attr = array(
															...
															'value' => set_value('username') // Gunakan set_value() untuk mempertahankan nilai input
														);
												...
												<label class="block clearfix">
													<span class="block input-icon input-icon-right">
														...
														$password_attr = array(
															...
															'value' => set_value('password') // Gunakan set_value() untuk mempertahankan nilai input
														);
