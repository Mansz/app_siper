...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>petugas/Home" class="logo">
      ...
      <span class="logo-lg"><b>PERPUS</b>SMK NUHA</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <center>
        <a href="<?php echo base_url();?>petugas/Home">
          <img src="<?php echo base_url(); ?>assets2/img/nuha.png" alt="" srcset="" width="47px">
        </a>
      </center>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2024 <a href="">SMK NUHA BREBES</a>.</strong> All rights reserved.
  </footer>
